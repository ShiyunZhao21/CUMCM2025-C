...
def q2q2add_noise_to_gw(q2q2df_original, q2q2noise_std):
    q2q2df_noisy = q2q2df_original.copy()
    q2q2noise = np.random.normal(0, q2q2noise_std, size=len(q2q2df_noisy))
    q2q2df_noisy['计算孕周GW'] = q2q2df_noisy['计算孕周GW'] + q2q2noise
    q2q2df_noisy['计算孕周GW'] = np.clip(q2q2df_noisy['计算孕周GW'], 0, 35)
    return q2q2df_noisy


def q2q2calculate_parameter_error(q2q2params_original, q2q2params_noisy):
    q2q2keys = ['B1', 'B2', 'B3', 'T1', 'T2', 'T3', 'T4']
    q2q2errors = {}
    for q2q2key in q2q2keys:
        q2q2errors[q2q2key] = q2q2params_noisy[q2q2key] - q2q2params_original[q2q2key]
    return q2q2errors


q2q2noise_std = 0.1
q2q2df_noisy = q2q2add_noise_to_gw(q2q2df_sorted, q2q2noise_std)

q2q2ga_noisy = q2q2GeneticAlgorithm(q2q2df_noisy, q2q2pop_size=50, q2q2generations=300, q2q2mutation_rate=0.15)
q2q2best_solution_noisy, q2q2fitness_history_noisy = q2q2ga_noisy.q2q2run()

if q2q2best_solution_noisy:
    print(f"最佳NIPT时间: T1={q2q2best_solution_noisy['T1']}, T2={q2q2best_solution_noisy['T2']}, T3={q2q2best_solution_noisy['T3']}, T4={q2q2best_solution_noisy['T4']}")
    print(f"BMI分组: B1={q2q2best_solution_noisy['B1']:.2f}, B2={q2q2best_solution_noisy['B2']:.2f}, B3={q2q2best_solution_noisy['B3']:.2f}")
    print(f"目标函数值: {q2q2best_solution_noisy['fitness']:.4f}")
